    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            if event.key == K_a:
                ...
                interval.response(pianokeys[0].note, time)
            if event.key == K_w:
                pianokeys[1].pressed(time)
                interval.response(pianokeys[1].note, time)
            if event.key == K_s:
                pianokeys[2].pressed(time)
                interval.response(pianokeys[2].note, time)
            if event.key == K_e:
                pianokeys[3].pressed(time)
                interval.response(pianokeys[3].note, time)
            if event.key == K_d:
                pianokeys[4].pressed(time)
                interval.response(pianokeys[4].note, time)
            if event.key == K_f:
                pianokeys[5].pressed(time)
                interval.response(pianokeys[5].note, time)
            if event.key == K_t:
                pianokeys[6].pressed(time)
                interval.response(pianokeys[6].note, time)
            if event.key == K_g:
                pianokeys[7].pressed(time)
                interval.response(pianokeys[7].note, time)
            if event.key == K_y:
                pianokeys[8].pressed(time)
                interval.response(pianokeys[8].note, time)
            if event.key == K_h:
                pianokeys[9].pressed(time)
                interval.response(pianokeys[9].note, time)
            if event.key == K_u:
                pianokeys[10].pressed(time)
                interval.response(pianokeys[10].note, time)
            if event.key == K_j:
                pianokeys[11].pressed(time)
                interval.response(pianokeys[11].note, time)
            if event.key == K_k:
                pianokeys[12].pressed(time)
                interval.response(pianokeys[12].note, time)
